...
export function navFor(role: Role, counts: { review: number; myWork: number; allOpen: number }): NavItem[] {
  ...
  else items.push({ href: "/app/tickets", label: "Tickets", icon: "tickets", badge: counts.allOpen });
